...
import Checkboxes from "../../components/header/checkbox";
...
const SearchPage = () => {
  ...
  //   return filteredArr.map((obj) => ResultDisplay(obj))
  //   // return filteredArr;
  // }, [testerArr, isDairyFree, isVegetarian, isVegan]);
